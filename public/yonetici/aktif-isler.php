...
<head>
    ...
    <style>
        ...
        .operation-card:hover { transform: translateY(-4px); box-shadow: 0 12px 24px rgba(0,0,0,0.15); }
    </style>
</head>
<body class="min-h-screen bg-slate-50">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="w-64 sidebar-gradient text-white flex flex-col transition-transform duration-300 ease-in-out lg:translate-x-0 -translate-x-full fixed lg:static inset-y-0 left-0 z-30 dark-scrollbar">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto dark-scrollbar">
                ...
                <a href="aktif-isler.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-orange-500/20 text-white font-medium border border-orange-500/30">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="bg-white rounded-lg shadow-md p-1 flex space-x-1">
                        <button onclick="filterOperations('')" id="btnAll" class="px-6 py-2 rounded-md font-medium text-sm transition bg-orange-600 text-white">
                            Tümü
                        </button>
                    ...
                    <div class="flex items-center space-x-2 text-sm text-slate-600">
                        ...
                        <span id="operationCount" class="font-bold text-orange-600">0</span>
                        <span>işlem</span>
                    </div>
                </div>
    ...
    <script>
        ...
        function filterOperations(tip) {
            ...
            // Button states - Orange accent for Yönetici
            document.getElementById('btnAll').className = tip === ''
                ? 'px-6 py-2 rounded-md font-medium text-sm transition bg-orange-600 text-white'
        ...
        function renderOperations(data) {
            ...
            const cardsHTML = data.map(op => {
                ...
                // Gün hesaplaması - DOĞRU YOL (Legacy bug fixed)
                const bugun = new Date();
                bugun.setHours(0, 0, 0, 0); // Midnight normalization
