    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="w-64 sidebar-gradient text-white flex flex-col transition-transform duration-300 ease-in-out lg:translate-x-0 -translate-x-full fixed lg:static inset-y-0 left-0 z-30 dark-scrollbar">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto dark-scrollbar">
                ...
                <a href="gecmis.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-orange-500/20 text-white font-medium border border-orange-500/30">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-orange-500">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button onclick="clearFilters()" class="text-sm text-orange-600 hover:text-orange-700 font-medium">
                            Filtreleri Temizle
                        </button>
                    </div>
                    ...
                    <form id="filterForm" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="filterFirma" placeholder="Firma adı..." class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        </div>

                        <!-- Ürün -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-2">Ürün</label>
                            <input type="text" id="filterUrun" placeholder="Ürün adı..." class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        </div>

                        <!-- İşlem Tipi -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-2">İşlem Tipi</label>
                            <select id="filterTip" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="date" id="filterBaslangic" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        </div>

                        <!-- Bitiş Tarihi -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-2">Bitiş Tarihi</label>
                            <input type="date" id="filterBitis" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        </div>

                        <!-- Sıralama -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-2">Sıralama</label>
                            <select id="filterSirala" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        ...
                        <div class="md:col-span-2 lg:col-span-3 flex items-end">
                            <button type="button" onclick="searchHistory()" class="w-full md:w-auto px-8 py-3 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-lg transition flex items-center justify-center space-x-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span id="resultSummary" class="text-sm text-orange-700"></span>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-slate-800 text-white">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider">Tarih</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider">Tip</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider">Firma</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider">Ürün</th>
                                    <th class="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider">Adet</th>
                                    <th class="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider">Tutar</th>
